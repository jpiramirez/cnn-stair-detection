...
#model.load_weights( 'models/mobilenet_fusion_weights_400' )                     # Current model

# TRAINING THE MODEL
checkpoint_filepath = '/models/mobilenet_fusion_3class_weights_{epoch:02d}'
...
cmd = 'mkdir ' + path
os.system( cmd )
filename = 'mobilenet_fusion_3class_weights_%d' % (G.EPOCHS)
