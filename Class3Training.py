...
#model.load_weights( 'models/mobilenet_3class_weights_600' )

checkpoint_filepath = '/models/mobilenet_3class_weights_{epoch:02d}'
...
cmd = 'mkdir ' + path
os.system( cmd )
filename = 'mobilenet_3class_weights_%d' % (G.EPOCHS)
